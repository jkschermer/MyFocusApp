...
class NotificationUtil {
    companion object {
        ...
        private const val CHANNEL_NAME_TIMER = "Focus_app"
        ...
        fun showTimerExpired(context: Context) {
            ...
            val nBuilder = getBasisNotificationBuilder(context, CHANNEL_ID_TIMER, true)
            nBuilder.setContentTitle("Timer Expired!")
                .setContentText("Start again?")
                .setContentIntent(getPendingIntentWithStack(context, TimerActivity::class.java))
                .addAction(R.id.btnStart, "Start",startPendingIntent)
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long) {
            ...
            nBuilder.setContentTitle("Timer is running!")
                ...
                .setContentIntent(getPendingIntentWithStack(context, TimerActivity::class.java))
                .setOngoing(true)
                .addAction(R.id.btnStop, "Stop",stopPendingIntent)
                .addAction(R.id.btnPause, "Pause",pausePendingIntent)
        ...
        fun showTimerPaused(context: Context) {
            ...
            nBuilder.setContentTitle("Timer is Paused!")
                ...
                .setContentIntent(getPendingIntentWithStack(context, TimerActivity::class.java))
                .setOngoing(true)
                .addAction(R.id.btnStart, "Resume",resumePendingIntent)
        ...
        private fun getBasisNotificationBuilder(context: Context, channelId: String, playSound: Boolean):
